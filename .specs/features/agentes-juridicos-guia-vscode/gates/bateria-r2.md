# Bateria r2 (pós gates r1) — 2026-09-25

```
Fri Sep 25 14:48:34 -03 2026
ℹ pass 17
ℹ fail 0
ℹ skipped 0
...
killed   zip-velho ← S2
killed   zip-fundo ← S2
killed   link-plugin-errado ← S4 obrigado: extensão, pasta, deep link e plano B
killed   link-marketplace-git ← S4 obrigado: extensão, pasta, deep link e plano B
killed   sem-pasta ← S4 obrigado: extensão, pasta, deep link e plano B (page.textContent: Timeout 30000ms exceeded.)
killed   volta-terminal ← S5 obrigado: sem terminal, git ou comandos de shell
...
killed   sem-auto-avanco ← P2+P3 ok: vai para ?r=ok, aviso ok, 1 evento, corpo certo (page.waitForSelector: Timeout 3000ms exceeded.) | P3 reload da obrigado não repete o evento (page.waitForSelector: Timeout 3000ms exceeded.) | P2+P3 502: vai para ?r=erro, aviso de erro, sem evento (page.waitForSelector: Timeout 3000ms exceeded.) | P2 504 com HTML: vai para ?r=erro (page.waitForSelector: Timeout 3000ms exceeded.) | P2 falha de rede: vai para ?r=erro (page.waitForSelector: Timeout 3000ms exceeded.) | P2 sem resposta: timeout de 25 s vai para ?r=erro (page.waitForSelector: Timeout 3000ms exceeded.) | P3 erro e depois ?r=ok na mesma aba: sem evento (page.waitForSelector: Timeout 3000ms exceeded.) | P2 400: pede correção, fica na landing (page.waitForSelector: Timeout 3000ms exceeded.) | P2 duplo envio: 1 requisição, botão "Enviando…" (page.waitForSelector: Timeout 3000ms exceeded.) | F-2 clique numa opção avança e foca a próxima (page.waitForSelector: Timeout 3000ms exceeded.) | F-4 áreas: marcar não avança; Continuar avança (page.waitForSelector: Timeout 3000ms exceeded.) | F-6 Voltar: pergunta anterior com a resposta; do contato volta à 9 (page.waitForSelector: Timeout 3000ms exceeded.) | F-8 duplo toque: o 2º toque não marca a pergunta seguinte (page.waitForSelector: Timeout 3000ms exceeded.) | F-10 tocar de novo na opção já marcada (depois de Voltar) avança (page.waitForSelector: Timeout 3000ms exceeded.) | P4 375px: sem scroll horizontal (landing e obrigado) (page.waitForSelector: Timeout 3000ms exceeded.) | P7 Voltar da obrigado (bfcache): botão habilitado (page.waitForSelector: Timeout 3000ms exceeded.)
...
killed   foca-no-load ← F-1 no load: só a pergunta 1, "Pergunta 1 de 10", sem Voltar
...
killed   enter-envia ← F-9 Enter numa opção marcada vale como Continuar (page.waitForSelector: Timeout 3000ms exceeded.) | F-11 a trava não barra o Espaço do teclado (page.waitForSelector: Timeout 3000ms exceeded.)
killed   sem-retoque ← F-10 tocar de novo na opção já marcada (depois de Voltar) avança (page.waitForSelector: Timeout 3000ms exceeded.)
killed   trava-teclado ← F-11 a trava não barra o Espaço do teclado
killed   duplo-envio ← P2 duplo envio: 1 requisição, botão "Enviando…" | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado | P7 Voltar da obrigado (bfcache): botão habilitado (page.waitForSelector: Timeout 3000ms exceeded.)
killed   sem-enviando ← P2 duplo envio: 1 requisição, botão "Enviando…" | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado | P7 Voltar da obrigado (bfcache): botão habilitado (page.waitForSelector: Timeout 3000ms exceeded.)
killed   areas-string ← P2+P3 ok: vai para ?r=ok, aviso ok, 1 evento, corpo certo | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado
killed   sem-foco-pergunta ← F-5 Continuar sem resposta: não avança e foca a pergunta | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado
killed   honeypot-company ← F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado | fool-W8 honeypot fora do autofill (nome/autocomplete)
killed   evento-no-erro ← P2+P3 502: vai para ?r=erro, aviso de erro, sem evento | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado
killed   evento-sem-token ← P3 reload da obrigado não repete o evento | P3+P5 acesso direto com ?r=ok: sem evento | P3 erro e depois ?r=ok na mesma aba: sem evento | P2 400: pede correção, fica na landing | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado
killed   evento-no-reload ← P3 reload da obrigado não repete o evento | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado
killed   indexavel ← P5 obrigado: noindex; sem r, guia sem aviso; requisito (R3) (page.getAttribute: Timeout 30000ms exceeded.)
killed   sem-requisito ← P5 obrigado: noindex; sem r, guia sem aviso; requisito (R3) | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado
killed   aviso-sem-status ← P5 obrigado: noindex; sem r, guia sem aviso; requisito (R3) | F-8 duplo toque: o 2º toque não marca a pergunta seguinte | F-11 a trava não barra o Espaço do teclado
killed   guia-diverge ← guide-sync
exit=0
Fri Sep 25 15:11:39 -03 2026
```
