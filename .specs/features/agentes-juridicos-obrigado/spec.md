...
| P4′ | O P4 vale para a obrigado: 375 px sem scroll horizontal. As abas Mac/Windows saíram em 2026-09-25 (ver ../agentes-juridicos-guia-vscode/spec.md). | Playwright + validate-gate | — (auditoria) |
