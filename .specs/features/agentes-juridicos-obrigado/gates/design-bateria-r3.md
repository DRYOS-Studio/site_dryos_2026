# Bateria r3 (pós design-gates r1) — `GUIDE_README=<README local> node tests/mutate-page.js` (2026-09-25)

Baseline do e2e e do guide-sync verde antes das mutações (fail-closed).
