# Bateria r2 (pós fool-gate specify r1, URL plana) — `node tests/mutate-page.js` (2026-09-25)

G4′: `guide-sync.js` contra a obrigado = exit 0; contra cópia com `claude` → `claude --x` = exit 1 (`guia-diverge` morta).
